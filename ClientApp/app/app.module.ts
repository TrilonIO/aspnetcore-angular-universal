  ...
  imports: [
    ...
    RouterModule.forRoot([
      ...
      },
      {
        ...
        data: {
          title: 'Login',
          meta: [{ name: 'description', content: 'This is a login page Description!' }],
          links: [
            { rel: 'canonical', href: 'http://blogs.example.com/chat/something' },
            { rel: 'alternate', hreflang: 'es', href: 'http://es.example.com/login' }
          ]
        }
      },
      {
        ...
        data: {
          title: 'Admin',
          meta: [{ name: 'description', content: 'This is a admin page Description!' }],
          links: [
            { rel: 'canonical', href: 'http://blogs.example.com/chat/something' },
            { rel: 'alternate', hreflang: 'es', href: 'http://es.example.com/admin' }
          ]
        }
      },
      {
